...
public class LevelSevenScreen extends GameScreen implements Screen {

    public LevelSevenScreen(GaryGame game){
        super(game);
        super.setBackground(new Texture(Gdx.files.internal("assets/LevelSevenBackground.jpg")));
