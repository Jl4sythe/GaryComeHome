...
public class Constants {
    ...
    public final static float GRAVITY = -981f;
    public final static float GARY_SPEED = 266.5f;
    public final static int GARY_WIDTH = 133;
    public final static int GARY_HEIGHT = 112;
    public final static float FLOOR = 100;
    public final static int SHELL_SIZE = 25;
}
